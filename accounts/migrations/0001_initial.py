    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stars', models.ManyToManyField(related_name='fans', to=settings.AUTH_USER_MODEL, verbose_name='我关注的人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(None, 'Unknown'), (0, 'Male'), (1, 'Female')], verbose_name='性别')),
                ('location', models.CharField(blank=True, max_length=64, verbose_name='地区')),
                ('about_me', models.TextField(blank=True, verbose_name='个性签名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='accounts.region', verbose_name='上级地区')),
            ],
            options={
                'verbose_name': '行政区划',
